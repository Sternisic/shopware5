...
class Category extends \Shopware\Models\Category\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'customerGroups', 'attribute', 'emotions', 'media', 'sortingIds', 'hideSortings', 'facetIds', 'shops', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'id', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'parentId', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'streamId', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'stream', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'parent', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'name', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'position', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'metaTitle', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'metaKeywords', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'metaDescription', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'cmsHeadline', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'cmsText', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'active', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'template', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'productBoxLayout', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'blog', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'path', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'external', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'externalTarget', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'hideFilter', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'hideTop', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'children', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'articles', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'allArticles', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'changed', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'added', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'mediaId', '' . "\0" . 'Shopware\\Models\\Category\\Category' . "\0" . 'manualSorting'];
        }
     ...
     * {@inheritDoc}
     */
    public function getManualSorting(): \Doctrine\Common\Collections\Collection
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getManualSorting', []);

        return parent::getManualSorting();
    }

    /**
     * {@inheritDoc}
     */
    public function setManualSorting(?array $manualSorting): \Shopware\Models\Category\Category
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setManualSorting', [$manualSorting]);

        return parent::setManualSorting($manualSorting);
    }
